...
#commented out, belongs to the image
...
canvas.grid(row=1, column=0,sticky=N, ipadx=5000,ipady=500,rowspan=999)


canvas.bind('<Motion>',motion) #mouse method applied to the label(picture) object. Only when on the picture, the method will be activated
#The main loop
