...
class import_data:
    def __init__(self):
        ...
        self.geweldsdelicten_data = pd.read_csv('Data/Geweldsdelicten2006-2011.csv', sep=';')
        self.fietsendiefstal_data = pd.read_csv('Data/Fietsendiefstal2006-2011.csv', sep=';')
        self.drugsoverlast_data = pd.read_csv('Data/Geweldsdelicten2006-2011.csv', sep=';')
        self.tevredenheid_data = pd.read_csv('Data/Tevredenheid2006-2011.csv', sep=';')
        self.afkomst_data = pd.read_csv('Data/Afkomst.csv', sep=';')
        self.vi2016_data = pd.read_csv('Data/VI2016.csv', sep=';', encoding='latin-1')
        self.si2016_data = pd.read_csv('Data/SI2016.csv', sep=';', encoding='latin-1')
        self.fisub2016_data = pd.read_csv('Data/FIsub2016.csv', sep=';', encoding='latin-1')
        self.fiobj2016_data = pd.read_csv('Data/FIobj2016.csv', sep=';', encoding='latin-1')
