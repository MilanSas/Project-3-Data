...
class import_data:
    def __init__(self):
        ...
        self.vi_data = pd.read_csv('https://raw.githubusercontent.com/MilanSas/Project-3-Data/master/Data/VI2016.csv', sep=';', encoding='latin-1')
        self.si_data = pd.read_csv('https://raw.githubusercontent.com/MilanSas/Project-3-Data/master/Data/SI2016.csv', sep=';', encoding='latin-1')
    ...
    def lower_columns(self):
        ...
        self.vi_data.columns = [c.lower() for c in self.vi_data.columns]
        self.si_data.columns = [c.lower() for c in self.si_data.columns]
    ...
    def create_database(self):
        ...
        self.vi_data.to_sql("vi2016", self.engine)
        self.si_data.to_sql("si2016", self.engine)
