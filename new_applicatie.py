...
root.geometry('{}x{}'.format(screenx, screeny)) #allows option boxes(minimize. maximize etc)
...
canvas.move(overschie_polgon.shape,rs(-300),rs(-30))
canvas.move(hillegersberg_polygon.shape,rs(-300),rs(-30))
canvas.move(prins_alexander_polygon.shape,rs(-300),rs(-30))
canvas.move(kralingen_polygon.shape,rs(-300),rs(-30))
canvas.move(noord_polygon.shape,rs(-300),rs(-30))
canvas.move(delftshaven_polygon.shape,rs(-300),rs(-30))
canvas.move(centrum_polygon.shape,rs(-300),rs(-30))
canvas.move(feijenoord_polygon.shape,rs(-300),rs(-30))
canvas.move(ijsselmonde_polygon.shape,rs(-300),rs(-30))
canvas.move(charlois_polygon.shape,rs(-300),rs(-30))
canvas.move(waalhaven_polygon.shape,rs(-300),rs(-30))

#volgende twee lijnen zijn niet nodig, dit wordt al gedaan in 'def changecolor()'
# setattr(overschie_polgon,'color',(170,250,220))#hoort niet te kunnen maar crasht niet en past niks toe
